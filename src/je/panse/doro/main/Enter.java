...
public class Enter {
	...
	public static String whab  = (wd + "/form/NEW/3HAB");
	public static String wbmi  = (wd + "/form/NEW/4BMI");
	public static String wbp   = (wd + "/form/NEW/5BP");
	public static String wlab  = (wd + "/form/NEW/6LAB");
	public static String wacc  = (wd + "/form/NEW/7ACC");
	public static String wplan = (wd + "/form/NEW/8PLAN");
    //------------------------------------------------------------------------------------
