	...
	public static void main(String[] string) throws Exception {
		...
		try {	
			while (true) {
				...
				switch (select_code) {
					case 1 :Menu_list.main(Enter.wt + "/singlebeam/ChartPopUpMenu"); 
						st2.main(null);break;
					
					case 2 :Menu_list.main(Enter.wt + "/singlebeam/ChartPopUpMenu"); 
						st3.callchartlist("/knots/soap");
						st2.main(null);break;
					
					case 3 :Menu_list.main(Enter.wt + "/singlebeam/DisMenu"); 
						st4.main(null);break;  // Disease Category
					
					case 4 :Menu_list.main(Enter.wt + "/singlebeam/ItemMenu");
